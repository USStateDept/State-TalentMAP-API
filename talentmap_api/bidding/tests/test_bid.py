...
def test_bid_bidder_actions(authorized_client, authorized_user):
    ...
    assert bid.draft_date.date() == datetime.datetime.now().date()
    ...
    assert bid.draft_date.date() == datetime.datetime.now().date()
    assert bid.submitted_date.date() == datetime.datetime.now().date()
    assert not bid.is_priority
    ...
    assert bid.draft_date.date() == datetime.datetime.now().date()
    assert bid.submitted_date.date() == datetime.datetime.now().date()
    assert bid.handshake_accepted_date.date() == datetime.datetime.now().date()
    ...
    assert bid.draft_date.date() == datetime.datetime.now().date()
    assert bid.submitted_date.date() == datetime.datetime.now().date()
    assert bid.handshake_declined_date.date() == datetime.datetime.now().date()
    assert not bid.is_priority
...
def test_bid_ao_actions(authorized_client, authorized_user):
    ...
    assert in_bureau_bid.handshake_offered_date.date() == datetime.datetime.now().date()
    ...
    assert in_bureau_bid.in_panel_date.date() == datetime.datetime.now().date()
    ...
    assert in_bureau_bid.approved_date.date() == datetime.datetime.now().date()
    assert in_bureau_bid.is_priority
    ...
    assert in_bureau_bid.declined_date.date() == datetime.datetime.now().date()
