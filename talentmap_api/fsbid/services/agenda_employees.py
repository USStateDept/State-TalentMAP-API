...
def get_v3_persons(pk, jwt_token=None, host=None):
    '''
    ...
    args = {
        ...
        "jwt_token": jwt_token,
        'mapping_function': v3_persons_to_tm,
        "count_function": None,
        "base_url": '',
        "host": host,
...
def convert_v3_persons_query(query):
    ...
    values = {
        ...
        "rp.filter": services.convert_to_fsbid_ql([
            {'col': 'perdetseqnum', 'val': query.get("perdetseqnum", None)},
        ]),
    }
