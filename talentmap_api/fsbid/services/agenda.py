...
def fsbid_legs_to_talentmap_legs(data):
    ...
    res = {
        ...
        "tod": tod_code,
        "tourOfDutyMonths": pydash.get(data, "ailtodmonthsnum", None),
        "tourOfDutyOtherText": tod_other_text,
        "tod_short_desc": handle_other_tod(tod_code, tod_other_text, tod_short_desc),
        "tod_long_desc": handle_other_tod(tod_code, tod_other_text, tod_long_desc),
...
def fsbid_aia_to_talentmap_aia(data):
    ...
    return {
        ...
        "tod": tod_code,
        "tourOfDutyMonths": pydash.get(data, "asgdtodmonthsnum", None),
        "tourOfDutyOtherText": tod_other_text,
        "tod_short_desc": handle_other_tod(tod_code, tod_other_text, tod_short_desc),
        "tod_long_desc": handle_other_tod(tod_code, tod_other_text, tod_long_desc),
