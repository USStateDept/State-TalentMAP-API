...
def convert_pv_query(query):
    ...
    values = {
        ...
        "fv_request_params.bureaus": services.convert_multi_value(query.get("position__bureau__code__in")),
        ...
        "fv_request_params.bureaus2": services.convert_multi_value(query.get("position__bureau__code__in-tandem")),
